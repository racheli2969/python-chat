...
def main():
    ...
    while True:
        ...
        # goes over the read list and responds to the current request
    ...
    print("No clients left. Closing the server.")
    # Close sockets
    server_socket.close()
...
def handle_name_command(client_socket, name):
    """attaches name to client and returns a greeting"""
...
def handle_msg_command(client_socket, recipient, message):
    """sends message from client socket to recipient"""
